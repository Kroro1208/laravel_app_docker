                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full rounded ">
                                            <div class="relative">
                                                ...
                                                <select name="age" class="rounded border-gray-300">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <input type="checkbox" id="caution" name="caution" class="rounded border-gray-300 mr-2">注意事項に同意する
                                            </div>
                                        </div>

                                        <div class="p-2 w-full">
                                            <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">送信する</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
